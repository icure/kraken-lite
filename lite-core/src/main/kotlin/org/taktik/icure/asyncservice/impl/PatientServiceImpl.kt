...
class PatientServiceImpl(
	...
	override fun purgePatients(patientId: List<IdAndRev>): Flow<DocIdentifier> = patientLogic.purgeEntities(patientId)
	...
	): Flow<MergeResult> = patientLogic.solveConflicts(limit, ids, strategy)
}
