...
class ClassificationTemplateServiceImpl(
    ...
    override fun deleteClassificationTemplates(ids: Collection<String>): Flow<ClassificationTemplate> = classificationTemplateLogic.deleteEntities(ids.map { IdAndRev(it, null) })
    override suspend fun deleteClassificationTemplate(classificationTemplateId: String): ClassificationTemplate = classificationTemplateLogic.deleteEntity(classificationTemplateId, null)
