...
class FormServiceImpl(
	...
	override fun purgeForms(formIds: List<IdAndRev>): Flow<DocIdentifier> = formLogic.purgeEntities(formIds)

	override suspend fun undeleteForm(id: String, rev: String): Form = formLogic.undeleteEntity(id, rev)
	override fun undeleteForms(formIds: List<IdAndRev>): Flow<Form> = formLogic.undeleteEntities(formIds)
